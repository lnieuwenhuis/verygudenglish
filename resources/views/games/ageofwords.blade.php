...
<body style="overflow: hidden; pointer-events: none; background: #1F6925">
    <script>
        ...
        class PlayerTroopGameObject extends Phaser.Physics.Arcade.Sprite {
            ...
            setupColliders() {
                this.overlap = this.scene.physics.add.overlap(this.units, this.units, this.handleUnitCollision,
                    null, this)
                this.overlapBuilding = this.scene.physics.add.overlap(this.units, this.buildings, this
                    .handleUnitCollision, null, this)
            }
        ...
        function preloadScene() { // images & html laden
            ...
            this.load.spritesheet('tankTroopIdle', '../storage/images/ageofwords/sprites/troops/idle/tankTroop.png', {
                frameWidth: 178,
                frameHeight: 131,
                endFrame: 48
            });
            ...
            this.load.spritesheet('tankTroopAttack', '../storage/images/ageofwords/sprites/troops/attack/tankAttack.png', {
                frameWidth: 218,
                frameHeight: 134,
                endFrame: 45
            });
        ...
        function createScene() {
                ...
                if (gameConfig.coins.player >= 25) {
                    if (gameConfig.troopsInQueue.player < 5) {
                        ...
                        if (!this.playerDone) {
                            ...
                            const delayEnemy = gameConfig.troopsInQueue.enemy * 3000;

                            setTimeout(() => {
                                const troop = new PlayerTroopGameObject(this, 1390, 320, 'meleeTroop',
                                    true);
            ...
            tankBuyButton.on('pointerdown', () => {
                if (gameConfig.coins.player >= 80) {

                    if (gameConfig.troopsInQueue.player < 5) {
                        gameConfig.coins.player -= 80;
                        gameConfig.troopsInQueue.player += 1;
        ...
        function updateScene() {
            ...
            if (gameConfig.alive.enemy < 1) {
                gameConfig.alive.enemy += 1;
                gameConfig.troopsInQueue.enemy += 1;

                const delayEnemy = gameConfig.troopsInQueue.enemy * 6000;
